...
} from "../../infrastructure/inventory/repository.ts";
import {
  type InventoryItem,
  ...
  getAvailableStock,
} from "../../domain/inventory/entities.ts";
import { type ReservationStatus, ReservationStatus as RS } from "../../domain/inventory/types.ts";
