...
import type { CustomerCockpit, CrmCustomerListItem, CrmTask } from "../../domain/crm/entities.ts";
import type { CrmTaskType, CrmTaskStatus, CrmTaskPriority, CrmCustomerStatus } from "../../domain/crm/types.ts";
import { VALID_CUSTOMER_STATUSES } from "../../domain/crm/types.ts";
